...
<form method="post" class="form">
				...
				<div class="paddingcontainerP" >
					...
					?>
							<?php if($page['id'] == $p['page_reference']): ?>
								...
								<label class="separarlinhas" > <span style="margin-left: 10px;background:#2bb515;color:white;padding:3px;" ><?php echo $total++; ?></span> <input style="float: left;margin-top: 2px;" type="checkbox" <?php echo(in_array($p['id'], $group_info['params'])) ? 'checked="checked"':''; ?> name="permissions[]" class="permissions" value="<?php echo $p['id']; ?>" /> <?php echo '&nbsp;'.$p['name_apresentar']; ?></label><br/>
	...
	<input type="submit" class="btn btn-info add" value="Editar" >
